...
Original file is located at
    https://colab.research.google.com/drive/1yS2xNc5UQ7hKTBvQ1JhiCQa2WRB7AIlf
"""

# Unet model
# from https://github.com/facebookresearch/fastMRI/blob/main/fastmri/models/unet.py

from torch.nn import Module, Conv3d, Linear, MaxPool3d,  ReLU, Dropout
...
class Unet(nn.Module):
    ...
    def forward(self, image: torch.Tensor) -> torch.Tensor:
        ...
        for layer in self.down_sample_layers:
            output = layer(output)
            stack.append(output)
            output = F.avg_pool3d(output, kernel_size=(2, 2, 2), stride=(2, 2, 2), padding=(0, 0, 0))
